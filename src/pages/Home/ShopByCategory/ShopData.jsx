...
const ShopData = ({toy}) => {
    ...
    return (
        <div className="card w-96 mr-12 mt-16 mb-12 bg-base-100 shadow-xl border-2 border-red-600 sm:flex-col">
            ...
            <div className="card-body items-center text-center">
                ...
                <div className="card-actions">
                    <Link to={user? `toy/${_id}` : '/login'}><button   className="btn  bg-primary px-2 py-2 text-white">View Details</button></Link>
                </div>
            </div>
        </div>
    );
